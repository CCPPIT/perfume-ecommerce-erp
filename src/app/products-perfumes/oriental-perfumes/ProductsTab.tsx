// تبويب المنتجات المتقدم - إدارة العطور الشرقية
function ProductsTab() {
  const [searchTerm, setSearchTerm] = useState('');
  const [selectedCategory, setSelectedCategory] = useState('جميع الفئات');
  const [showFilters, setShowFilters] = useState(false);

  const orientalPerfumeProducts = [
    {
      id: 1,
      name: 'عود روز فاخر',
      brand: 'الشرقية للعطور',
      category: 'العود والورد الشرقي',
      price: '890 ريال',
      stock: 45,
      sales: 1280,
      rating: 4.8,
    ...
    },
    {
      id: 5,
      name: 'عود هندي أسود',
      brand: 'الهندية للعطور',
      category: 'العود الهندي التقليدي',
      price: '580 ريال',
      stock: 89,
      sales: 1890,
      rating: 4.8,
    ...
    {
      id: 6,
      name: 'مسك الغزال الفاخر',
      brand: 'غزال الشرق',
      category: 'المسك الشرقي الفاخر',
      price: '920 ريال',
      stock: 34,
      sales: 789,
      rating: 4.9,
  ...
  const categories = [
    ...
    'العود والورد الشرقي',
    'المسك الشرقي النقي',
    'العنبر الشرقي الفاخر',
    'الورد الشرقي النادر',
    'العود الهندي التقليدي'
  ];

  const filteredProducts = orientalPerfumeProducts.filter(product => {
