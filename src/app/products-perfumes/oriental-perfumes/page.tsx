// صفحة إدارة العطور الشرقية - قسم متخصص في فئة المنتجات والعطور
...
export default function OrientalPerfumesPage() {
  const [currentCategory, setCurrentCategory] = useState('products-perfumes');
  const [currentDepartment, setCurrentDepartment] = useState('إدارة العطور الشرقية');
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  إدارة شاملة للعطور الشرقية • قسم متخصص في التراث والأصالة
                </p>
              </div>
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {activeTab === 'overview' && <OrientalPerfumesOverviewTab />}
...
// نظرة عامة على العطور الشرقية
function OrientalPerfumesOverviewTab() {
  const perfumeStats = [
    {
      title: 'إجمالي العطور الشرقية',
      value: '1,234 عطر',
      change: '+89 هذا الشهر',
      trend: 'up',
      icon: Package,
  ...
  const perfumeCategories = [
    { category: 'العود والعنبر', count: 345, percentage: 28, color: 'amber' },
    { category: 'المسك والورد', count: 289, percentage: 23, color: 'pink' },
    { category: 'التوابل والخشب', count: 234, percentage: 19, color: 'orange' },
    { category: 'الفواكه والحمضيات', count: 178, percentage: 14, color: 'yellow' },
    { category: 'البخور واللبان', count: 123, percentage: 10, color: 'red' },
    { category: 'الزهور الشرقية', count: 65, percentage: 6, color: 'purple' }
  ];
  ...
  return (
    <div className="space-y-8">
            ...
            {perfumeCategories.map((cat, index) => (
              ...
              >
                <div className={`w-12 h-12 rounded-lg flex items-center justify-center bg-${cat.color}-100 dark:bg-${cat.color}-900/30`}>
                  <Mountain className={`w-6 h-6 text-${cat.color}-600`} />
                </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <TikTokCard className="p-6">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">
            خط تطوير العطور الشرقية
          </h3>

          <div className="space-y-4">
            {[
              { stage: 'البحث عن المكونات', count: 18, status: 'نشط', color: 'orange' },
              { stage: 'اختبار التركيبات التقليدية', count: 12, status: 'قيد المراجعة', color: 'yellow' },
              { stage: 'مراقبة الجودة والأصالة', count: 8, status: 'معتمد', color: 'green' },
              { stage: 'التعبئة بالطرق التقليدية', count: 14, status: 'قيد التنفيذ', color: 'purple' }
            ].map((stage, index) => (
              <motion.div
                key={index}
                className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl"
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <TikTokBadge className={
                      stage.status === 'نشط' ? 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400' :
        ...
        <TikTokCard className="p-6">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">
            مؤشرات الجودة للعطور الشرقية
          </h3>

          <div className="space-y-6">
            {[
              { metric: 'معدل الرضا عن الأصالة', value: 95.8, target: 95, status: 'ممتاز' },
              { metric: 'نسبة المنتجات التقليدية', value: 92.3, target: 90, status: 'ممتاز' },
              { metric: 'زمن اختبار الجودة', value: 3.2, target: 3.5, status: 'جيد جداً' },
  ...
  return (
    <TikTokCard className="p-8">
      <div className="text-center py-16">
        <Package className="w-20 h-20 text-orange-500 mx-auto mb-6" />
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
          إدارة منتجات العطور الشرقية
        </h3>
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          نظام شامل لإدارة جميع منتجات العطور الشرقية والمخزون والتتبع
        </p>
...
function DevelopmentTab() {
  return (
    <TikTokCard className="p-8">
      <div className="text-center py-16">
        <TreePine className="w-20 h-20 text-amber-500 mx-auto mb-6" />
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
          تطوير العطور الشرقية
        </h3>
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          تطوير عطور شرقية جديدة مع الحفاظ على التراث والأصالة
        </p>
  ...
  return (
    <TikTokCard className="p-8">
      <div className="text-center py-16">
        ...
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
          مراقبة جودة العطور الشرقية
        </h3>
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          ضمان جودة العطور الشرقية وتطبيق معايير الأصالة التقليدية
        </p>
        <TikTokButton size="lg">
  ...
  return (
    <TikTokCard className="p-8">
      <div className="text-center py-16">
        ...
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
          تقارير العطور الشرقية والأداء
        </h3>
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          تقارير مفصلة عن أداء العطور الشرقية والمبيعات والجودة والتطوير
        </p>
        <TikTokButton size="lg" variant="outline">
  ...
  return (
    <TikTokCard className="p-8">
      <div className="text-center py-16">
        ...
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
          إعدادات إدارة العطور الشرقية
        </h3>
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          تخصيص إعدادات نظام إدارة العطور الشرقية حسب احتياجات المؤسسة
        </p>
        <TikTokButton size="lg">
