// تبويب المنتجات المتقدم - إدارة عطور السيارات
function ProductsTab() {
  const [searchTerm, setSearchTerm] = useState('');
  const [selectedCategory, setSelectedCategory] = useState('جميع الفئات');
  const [showFilters, setShowFilters] = useState(false);

  const carPerfumeProducts = [
    {
      id: 1,
      name: 'معطر تعليق أسود',
      brand: 'كار فريش',
      category: 'معطرات تعليق',
      price: '45 ريال',
      stock: 234,
      sales: 3456,
      rating: 4.8,
    ...
    {
      id: 2,
      name: 'معطر رذاذ باللافندر',
      brand: 'أوتو سنت',
      category: 'معطرات رذاذ',
      price: '65 ريال',
      stock: 189,
      sales: 2890,
      rating: 4.7,
    ...
    {
      id: 5,
      name: 'معطر طبيعي بالأعشاب',
      brand: 'ناتشر كار',
      category: 'معطرات طبيعية',
      price: '85 ريال',
      stock: 156,
      sales: 1987,
      rating: 4.5,
  ...
  const filteredProducts = carPerfumeProducts.filter(product => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4 justify-between items-start lg:items-center">
        <div className="flex items-center gap-3">
          <TikTokButton size="lg" className="bg-slate-600 hover:bg-slate-700">
        ...
        {filteredProducts.map((product) => (
          ...
          >
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-slate-100 dark:bg-slate-900/30 rounded-lg flex items-center justify-center text-2xl">
                  {product.image}
                </div>
                <div>
      ...
      <div className="flex justify-center">
        <div className="flex items-center gap-2">
          ...
          <TikTokButton size="sm" className="bg-slate-600 text-white">1</TikTokButton>
