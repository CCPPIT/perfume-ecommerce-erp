// تبويب المنتجات المتقدم - إدارة العطور النسائية
function ProductsTab() {
  const [searchTerm, setSearchTerm] = useState('');
  const [selectedCategory, setSelectedCategory] = useState('جميع الفئات');
  const [showFilters, setShowFilters] = useState(false);

  const femalePerfumeProducts = [
    {
      id: 1,
      name: 'شانيل نمبر 5',
      brand: 'شانيل',
      category: 'عطور زهرية ألدهيدية',
      price: '890 ريال',
      stock: 67,
      sales: 2340,
      rating: 4.9,
    ...
    {
      id: 3,
      name: 'لانكوم لا في إيست بيل',
      brand: 'لانكوم',
      category: 'عطور زهرية فاكهية',
      price: '650 ريال',
      stock: 89,
      sales: 3120,
      rating: 4.7,
    ...
    {
      id: 6,
      name: 'توم فورد بلاك أوركيد',
      brand: 'توم فورد',
      category: 'عطور شرقية فاخرة',
      price: '1200 ريال',
      stock: 23,
      sales: 678,
      rating: 4.9,
  ...
  const filteredProducts = femalePerfumeProducts.filter(product => {
