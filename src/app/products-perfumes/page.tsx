// صفحة الفئة الثالثة: إدارة المنتجات والعطور
// تحتوي على 100 قسم متخصص في إدارة المنتجات والعطور
...
import { AdvancedSidebar } from '@/components/modules/general-management/SuperAdvancedSidebar';

export default function ProductsPerfumesPage() {
  ...
  const tabs = [
    ...
    { id: 'development', label: 'التطوير', icon: TestTube },
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  إدارة شاملة للمنتجات والعطور • 100 قسم متخصص
                </p>
              </div>
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {activeTab === 'overview' && <ProductsOverviewTab />}
...
// نظرة عامة على المنتجات والعطور
function ProductsOverviewTab() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Product Categories and Development Pipeline */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <TikTokCard className="p-6">
          ...
          <div className="space-y-4">
            {[
              { category: 'العطور الرجالية', count: 1234, percentage: 43, color: 'blue' },
              { category: 'العطور النسائية', count: 1613, percentage: 57, color: 'pink' },
              { category: 'العطور الشرقية', count: 892, percentage: 31, color: 'purple' },
              { category: 'الزيوت الأساسية', count: 445, percentage: 16, color: 'green' }
            ].map((cat, index) => (
              <motion.div
                key={index}
        ...
        <TikTokCard className="p-6">
          ...
          <div className="space-y-4">
            {[
              { stage: 'البحث والتطوير', count: 23, status: 'نشط' },
              { stage: 'اختبار المنتجات', count: 15, status: 'قيد المراجعة' },
              { stage: 'مراقبة الجودة', count: 8, status: 'معتمد' },
              { stage: 'التعبئة والتغليف', count: 12, status: 'قيد التنفيذ' }
            ].map((stage, index) => (
              <motion.div
                key={index}
                ...
                transition={{ delay: index * 0.1 }}
              >
                <div className="w-10 h-10 bg-gradient-to-r from-pink-100 to-rose-100 dark:from-pink-900/30 dark:to-rose-900/30 rounded-lg flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <TikTokCard className="p-6">
          ...
          <div className="h-64 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 rounded-xl flex items-center justify-center">
            <div className="text-center">
              <TrendingUp className="w-16 h-16 text-pink-500 mx-auto mb-4" />
              <p className="text-gray-600 dark:text-gray-400 mb-2">رسم بياني تفاعلي لأداء المنتجات</p>
        ...
        <TikTokCard className="p-6">
          ...
          <div className="space-y-6">
            {[
              { metric: 'معدل الرضا عن الجودة', value: 94.7, target: 95 },
              { metric: 'نسبة المنتجات المعتمدة', value: 96.2, target: 95 },
              { metric: 'زمن اختبار الجودة', value: 2.3, target: 2.5 },
              { metric: 'تكلفة مراقبة الجودة', value: 1.8, target: 2.0 }
            ].map((metric, index) => (
              <motion.div
                key={index}
                className="space-y-2"
    ...
    <TikTokCard className="p-8">
      <div className="text-center py-16">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          نظام شامل لإدارة جميع المنتجات والعطور والمخزون والتتبع
        </p>
...
function DevelopmentTab() {
  return (
    <TikTokCard className="p-8">
      <div className="text-center py-16">
        <TestTube className="w-20 h-20 text-purple-500 mx-auto mb-6" />
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
          البحث والتطوير
        </h3>
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          تطوير منتجات عطور جديدة وخلطات مبتكرة مع ضمان الجودة العالية
        </p>
  ...
  return (
    <TikTokCard className="p-8">
      <div className="text-center py-16">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          ضمان جودة المنتجات وتطبيق أعلى معايير الجودة في جميع مراحل الإنتاج
        </p>
        <TikTokButton size="lg">
  ...
  return (
    <TikTokCard className="p-8">
      <div className="text-center py-16">
        ...
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
          تقارير المنتجات والأداء
        </h3>
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          تقارير مفصلة عن أداء المنتجات والمبيعات والجودة والتطوير
        </p>
        <TikTokButton size="lg" variant="outline">
  ...
  return (
    <TikTokCard className="p-8">
      <div className="text-center py-16">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          تخصيص إعدادات نظام إدارة المنتجات والعطور حسب احتياجات المؤسسة
        </p>
        <TikTokButton size="lg">
